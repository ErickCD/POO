...
public class AppTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Desea ingresar informacion de un:\nAlumno = 1\nMaestro = 2\n3 = Persona");
    ...
    public static void proceso3() {
        ...
        System.out.print("Cuantos personas quiere registrar: ");
        int n = entrada.nextInt();
        ...
        for (int i = 0; i < n; i++) {
            System.out.printf("\nPersona: %d\n", (i + 1));
            System.out.print("Nombre(s) de la Persona: ");
            String nombre = texto.nextLine();
            System.out.print("Apellido paterno de la Persona: ");
            String apellidop = texto.nextLine();
            System.out.print("Apellido materno de la Persona: ");
            String apellidom = texto.nextLine();
            System.out.print("Ingrese la curp de la Persona: ");
            String curp = texto.nextLine();
            System.out.print("Que edad tiene la Persona?: ");
            int edad = entrada.nextInt();
